...
const LoginForm = () => {
  ...
  const isLogin = true; // Force login mode only - sign up disabled
  const [formData, setFormData] = useState({
    // name: '', // Sign up disabled
    email: '',
    password: '',
    // confirmPassword: '' // Sign up disabled
  });
  const [showPassword, setShowPassword] = useState(false);
  // const [showConfirmPassword, setShowConfirmPassword] = useState(false); // Sign up disabled
  ...
  // Sign up toggle functionality disabled
  // const toggleMode = () => {
  //   setIsLogin(!isLogin);
  //   setFormData({
  //     name: '',
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {/* Sign up confirm password field disabled */}
          {/* {!isLogin && (
            <div>
